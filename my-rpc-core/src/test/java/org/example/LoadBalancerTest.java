...
import org.example.rpc.loadbalancer.RandomLoadBalancer;
import org.example.rpc.loadbalancer.RoundRobinLoadBalancer;
...
public class LoadBalancerTest {
    ...
    public void select() {
        ...
        serviceMetaInfo1.setServicePort(String.valueOf(1234));
        ServiceMetaInfo serviceMetaInfo2 = new ServiceMetaInfo();
        serviceMetaInfo2.setServiceName("myService");
        serviceMetaInfo2.setServiceVersion("1.0");
        serviceMetaInfo2.setServiceHost("yupi.icu");
        serviceMetaInfo2.setServicePort(String.valueOf(80));
